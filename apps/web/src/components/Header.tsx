        ...
        <div ref={menuRef} className="relative">
          ...
          {menuOpen && (
            <div className="absolute left-0 top-12 w-52 bg-[#0e1115] border border-white/[0.08] rounded-xl shadow-2xl z-50 overflow-hidden py-1">
              {[
                { label: 'POS', to: '/', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
